<!-- Page Content -->
    <section id="logon">
      <div class="container">
        <h1 class="judul">What's New</h1>
        <!-- Nav tabs -->
		<div class="row">
		<div class="col-md-6 tab-isi">
			<ul class="nav nav-tabs" role="tablist">
			  <li class="nav-item">
				<a class="nav-link active" data-toggle="tab" href="#seminar" role="tab">Alumni Events</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link" data-toggle="tab" href="#jobfair" role="tab">Career Events</a>
			  </li>
			  <li class="nav-item">
				<a class="nav-link" data-toggle="tab" href="#events" role="tab">Job Vacancies</a>
			  </li>
			</ul>
			<!-- Tab panes -->
		...
		<div class="col-md-6 tab-isi">
			<div class="card card-login">
					...
					<div class="card-header" id="login">
						<h5 class="text-center"> Log In Form </h5>
					</div>
					 ...
					 <form>
						...
						<div class="form-group row">
							...
							<div class="col-md-12 ">
								...
								<button onclick="klik()" class="btn warna-kalbis">Log in</button>
								  </div>
								  <hr>
