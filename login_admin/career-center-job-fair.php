			...
			<div class="col-md-12">
				<div class="box box-success">
					<div class="box-header with-border">
						<h3 class="box-title">Job Fair List</h3>
                        <span>
                            <a href="career-center-job-fair-add.php" class="pull-right btn btn-success">Add Job Fair</a>
                        </span>
                        ...
                        <div class="col-xs-12">
                              <table class="table table-hover ">
                                ...
                                <tr>
								  ...
								  <td>  <a href="career-center-job-fair-update.php" class="btn btn-info"><i class="fa fa-trash"></i> Update</a>
